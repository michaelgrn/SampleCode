...
public class Song
{
	...
	/**
	 * Used to reduce the playCount when movingUp or movingDown
	 */
	void skipPlay(){
	...
	/**
	 * Sets the title of the <code>Song</code>
	 * @param title sets the title for the song
	 */
	...
	/**
	 * Sets the artist for this <code>Song</code>
	 * @param artist sets the artists
	 */
	...
	/**
	 * Sets the playtime for this song
	 * @param PlayTime returns the playtime of the song
	 */
	...
	/**
	 * Sets the filepath for this song
	 * @param filepath the location of the song on the harddrive
	 */
	...
	/**
	 * Returns the number of times this <code>Song</code> has been played.
	 * @return the count 
	 */
	...
	/**
	 * Plays this <code>Song</code> asynchronously.
	 */
	...
	/**
	 * Stops this <code>Song</code> from playing.
	 */
	...
	public void adjustSong(){
		playCount = playCount - 1;
	}
	
	/**
	 * To strings the <code>Song</code> called .
	 * @return the to strings for the selected songs.
	 */
	...
	{
		return String.format("%-27s %-35s %10d",
