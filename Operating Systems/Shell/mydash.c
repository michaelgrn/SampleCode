/* Project 1: Mydash part 1
 * Author: Michael Green
 * Date: Wed Jan 31 23:18:10 MST 2018
 *
 * The goal of this part of the project was to implement a fork exec
 * command for anything besides cd. Also to implement readline() and
 * version control.
 */
